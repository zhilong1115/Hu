...
| 梅开二度 | +2 弃牌次数 |
| 梅开三度 | +3 弃牌次数 |
| 寒梅傲雪 | 本次弃牌可弃 **任意数量**（仍只算1次） |
| 梅花三弄 | 弃牌后，可 **重新选择** 摸到的牌（看3选1） |
| 暗香浮动 | 下次弃牌时，弃掉的牌每张获得 **+5金币** |
| 一剪梅 | 弃1张牌，从牌库 **精确换取** 指定的1张牌 |
| 踏雪寻梅 | 弃掉所有手牌，从牌库 **重新抽14张** |
...
| 竹编生金 | 手牌中每张 **材质牌** +3 金币 |
| 青竹直上 | 获得金币 = **手牌中最大点数 × 3** |
| 竹马之交 | 本局每次 **吃/碰/杠** 额外 +5 金币 |
| 势如破竹 | 立即获得 **+30 金币**，但 -1 弃牌次数 |
...
| 秋菊傲霜 | 获得 **1张随机花牌** |
| 采菊东篱 | 获得 **1张随机季节牌** |
| 黄菊满地 | 将 **1张随机手牌** 添加 **随机材质** |
| 菊残犹傲 | 本局获得 **随机倍率**（×1.5 / ×2 / ×3，概率 50/35/15%） |
| 持菊问道 | 随机触发：获得2张花牌 **或** 获得20金币 **或** +2弃牌次数 |
| 金菊绽放 | 将 **最多3张随机手牌** 各添加 **随机材质** |
| 满城尽带黄金甲 | **超级轮盘**：50% 所有手牌加金牌材质，30% 获得50金币，20% 什么都不发生 |
